    ...
    try {
        ...
        if (videoPlayer && videoSource) {
            ...
            if (video.videoUrl) {
                ...
                // 对于OneDrive链接，直接使用原始链接
                // 让浏览器自己处理OneDrive的重定向
                if (videoSrc.includes('1drv.ms') || videoSrc.includes('onedrive.live.com')) {
                    console.log('使用原始OneDrive链接:', videoSrc);
                }
            } else {
                // 使用Google的可靠示例视频
